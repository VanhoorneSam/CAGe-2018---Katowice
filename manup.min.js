var manUpObject, tagArray = [], linkArray = [],
    validMetaValues = [{name: "mobile-web-app-capable", manifestName: "display"}, {
        ...
        manifestName: "icons",
        imageSize: "310x150"
    }, {name: "msapplication-square310x310logo", manifestName: "icons", imageSize: "310x310"}], validLinkValues = [{
    ...
    //TODO remove Project/Consumee/ from the link. Only needed for localhost
        for (var e = document.getElementsByTagName("link"), a = 0; a < e.length; a++) e[a].rel && "Projects/Consumee/manifest" == e[a].rel && makeAjax(e[a].href)
